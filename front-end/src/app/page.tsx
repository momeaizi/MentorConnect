  ...
  return (
    ...
    >
      <div className="flex flex-row justify-between	items-center	px-8">
        ...
        <p
          className="cursor-pointer	flex justify-center items-center text-xl box-border bg-white text-black rounded-3xl w-32 h-11 px-5 py-2 font-mono"
          style={{
      ...
      <div className="flex flex-col justify-center	items-center gap-3.5">
        ...
        <p 
          className="cursor-pointer	 flex justify-center items-center text-xl box-border bg-white text-white rounded-3xl w-48 h-12 px-3 py-6 font-mono bg-gradient-to-r from-pink-500 to-red-500"
          style={{
            fontFamily: '"Proxima Nova", "Helvetica Neue", Arial, Helvetica, sans-serif',
            fontSize: '20px',
            fontWeight: '600',
